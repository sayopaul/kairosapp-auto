/*
  # Trade Proposals and Shipping System

  1. New Tables
    - `trade_proposals` - Tracks trade proposals between users
    - `shipping_preferences` - Stores user shipping addresses
    
  2. Features
    - Complete trade proposal workflow (propose, accept, confirm)
    - Shipping method selection (mail or local meetup)
    - Address management for shipping
    - Automatic status transitions via triggers
    - Transaction creation for confirmed trades
*/
