/*
  ...
  2. Functions and Triggers
    - update_trade_proposal_status: Automatically updates status based on confirmation flags
    - create_transaction_for_confirmed_trade: Creates transaction records when trades are confirmed
    - update_match_status_from_proposal: Updates match status when proposal status changes
    - prevent_duplicate_trade_proposals: Prevents multiple active proposals for the same match
*/
