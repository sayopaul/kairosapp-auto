/*
  ...
  1. New Tables
    - `trade_proposals` table to track trade proposal status and details
    - `shipping_preferences` table to store user shipping preferences
    
  2. Schema Updates
    - Add new status options to matches table
    - Add shipping method and confirmation fields to transactions table
    
  3. Security
    - Add RLS policies for new tables
    - Ensure proper access controls for trade proposals
*/
