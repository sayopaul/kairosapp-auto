/*
  # Fix Duplicate Constraints and Clean Test Data

  1. Changes
    - Delete test data to avoid foreign key constraint violations
    - Fix unique constraint for trade proposals to prevent duplicates
    - Add function to prevent duplicate bundle matches
    - Add trigger for preventing duplicate bundle matches
*/
...
CREATE UNIQUE INDEX IF NOT EXISTS unique_single_trade_match ON matches (
